...
const ReportInsider: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="additional-content">
                <div className="content-container">
                    <div className="rectangle-box">
                        <p className="post-type-text">Reports</p>
                    </div>
            ...
            <div className="report-insider-reports">
